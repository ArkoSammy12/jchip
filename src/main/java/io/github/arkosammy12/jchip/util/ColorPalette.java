...
public class ColorPalette {
    ...
    private static final int[] PALETTE_CADMIUM = {
    ...
    private static final int[] PALETTE_SILICON8 = {
    ...
    private static final int[] PALETTE_PICO8 = {
    ...
    private static final int[] PALETTE_OCTO_CLASSIC = {
    ...
    private static final int[] PALETTE_LCD = {
    ...
    private static final int[] PALETTE_C64 = {
    ...
    private static final int[] PALETTE_INTELLIVISION = {
    ...
    private static final int[] PALETTE_CGA = {
            0x000000ff, 0xffffffff, 0xaaaaaaff, 0x555555ff,
    ...
    public ColorPalette(String colorPalette) {
        int[] chosenPalette = switch (colorPalette) {
            case "cadmium" -> PALETTE_CADMIUM;
            case "silicon8" -> PALETTE_SILICON8;
            case "pico8" -> PALETTE_PICO8;
