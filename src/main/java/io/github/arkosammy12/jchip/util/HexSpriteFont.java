...
public record HexSpriteFont(int[][] smallFont, int[][] bigFont) {
    ...
    public static final int[][] CHIP_48 = {
            {0xF0, 0x90, 0x90, 0x90, 0xF0}, // 0
    ...
    public static final int[][] SCHIP_10_BIG = {
    ...
    public static final int[][] SCHIP_11_BIG = {
    ...
    public static final int[][] OCTO_BIG = {
    ...
    public static final int[][] MEGACHIP_8_BIG = {
    ...
    public HexSpriteFont {
        smallFont = smallFont != null ? Arrays.stream(smallFont).map(int[]::clone).toArray(int[][]::new) : null;
        bigFont = bigFont != null ? Arrays.stream(bigFont).map(int[]::clone).toArray(int[][]::new) : null;
    }

    public Optional<int[][]> getSmallFont() {
